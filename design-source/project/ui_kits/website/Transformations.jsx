...
const TRANSFORMS = [
  { name: 'Sarah M.', type: 'Fat Loss', duration: '14 weeks', weight: '−12kg' },
  { name: 'Ciarán O.', type: 'Muscle Gain', duration: '12 weeks', weight: '+6kg' },
  { name: 'Darragh K.', type: 'Recomposition', duration: '16 weeks', weight: '−8kg' },
];
  ...
  return (
    <section style={{ background: bg, padding: '80px 0' }}>
      <div style={{ padding: '0 24px', marginBottom: 32, textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: theme === 'light' ? '#666' : '#888', marginTop: 12, lineHeight: 1.6 }}>
